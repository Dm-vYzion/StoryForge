...
describe('Auth routes', () => {
  it(
    'logs in with valid credentials and returns user + token',
    async () => {
  ...
  it(
    'returns current user from /api/auth/me when authenticated',
    async () => {
  ...
  it(
  'logs out and clears the auth cookie',
  async () => {
    const loginRes = await request(app)
      .post('/api/auth/login')
      .send({
...
it(
  'cannot access /api/auth/me after logout when cookie is cleared (realistic client)',
  async () => {
    const loginRes = await request(app)
      .post('/api/auth/login')
      .send({
...
it(
  'returns a user object with expected shape from /api/auth/me',
  async () => {
    const loginRes = await request(app)
      .post('/api/auth/login')
      .send({
