// StoryForge Mock Data - Pre-built Campaigns, Characters, Quests, and Anchors
...
export const campaigns = [
  ...
  },
  {
    ...
    worldTruths: [
      {
        id: "truth_a1",
        statement: "The Kingdom of Aldoria has been at war with the Shadowlands for 100 years.",
        category: "Historical Fact",
        visibility: "Known"
      },
      {
        id: "truth_a2",
        statement: "The Void Dragon sleeps beneath the capital, bound by five ancient seals.",
        category: "Cosmic Rule",
        visibility: "Hidden"
      }
    ],
    characters: [
      {
        ...
        equipment: {
          ...
          head: null, neck: null, cloak: null, feet: null, ring1: null, ring2: null
        },
        inventory: []
      },
      {
  ...
  },
  {
    ...
    worldTruths: [
      {
        id: "truth_m1",
        statement: "The innkeeper was poisoned, not stabbed as it appears.",
        category: "Historical Fact",
        visibility: "Secret"
      }
    ],
    characters: [
      {
        ...
        equipment: {
          ...
          offHand: null, body: null, head: null, neck: null, cloak: null, feet: null, ring1: null, ring2: null
        },
        inventory: []
      },
      {
...
// Initial quests for Ravencrest campaign
...
// Initial anchors for campaigns
export const initialAnchors = {
  "curse-of-ravencrest": {
    npcs: [
...
// Sample narrative turns for testing
export const sampleNarrative = [
  {
    turn: 1,
    type: "dm",
    content: "The carriage rattles to a halt before the looming silhouette of Ravencrest Manor. Lightning illuminates the Gothic spires against the churning sky as rain begins to fall. The driver refuses to go any further, muttering prayers under his breath as he unloads your belongings onto the muddy path.\n\nBefore you stands the iron gate, its hinges screaming in protest as the wind pushes it ajar. Beyond, the manor waits—windows dark like hollow eyes, watching your approach. The stories spoke of this place, of the curse that befell the Ravencrest family, of those who entered and never returned.\n\nYet here you stand, Viktor Ashford, ghost hunter, seeker of truth. Your sister came here six months ago, following the same rumors. She never came back.\n\nThe path splits ahead: the main entrance looms straight ahead, while a servants' path curves around toward the east wing. What do you do?",
    locationImage: "https://images.unsplash.com/photo-1518709268805-4e9042af9f23?w=1920&q=80"
  }
];

// Action buttons configuration
export const actionButtons = [
  { id: "attack", label: "Attack", icon: "Sword", color: "destructive" },
  { id: "persuade", label: "Persuade", icon: "MessageCircle", color: "secondary" },
  { id: "investigate", label: "Investigate", icon: "Search", color: "secondary" },
  { id: "stealth", label: "Stealth", icon: "Eye", color: "secondary" }
];
...
export const equipmentSlots = [
  ...
  { id: "body", label: "Body", icon: "Shield" },
  { id: "mainHand", label: "Main Hand", icon: "Sword" },
  { id: "offHand", label: "Off Hand", icon: "Shield" },
  { id: "cloak", label: "Cloak", icon: "Wind" },
  { id: "feet", label: "Feet", icon: "Footprints" },
  { id: "ring1", label: "Ring", icon: "Circle" },
  { id: "ring2", label: "Ring", icon: "Circle" }
];
...
export const rarityColors = {
  ...
  "Very Rare": "text-purple-400 border-purple-500",
  Legendary: "text-amber-400 border-amber-500",
  Artifact: "text-red-400 border-red-500"
};
